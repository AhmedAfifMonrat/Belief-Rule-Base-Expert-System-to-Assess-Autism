...
$con = mysql_connect("localhost","root","");
 ...
 die('Could not connect: ' . mysql_error());
  ...
  mysql_query("delete from gen_d_value");
 
mysql_select_db("brb", $con);
 
 $result = mysql_query("insert into gen_d_value values('$high','$medium','$low','$crisp')");
 
  mysql_select_db("brb", $con);
 
 $result = mysql_query("update consequent set genetic='active'");
