...
echo "<table width='1312' border='1' cellspacing='0' style='text-align:center'>";
  echo "<tr>";
    ...
    echo "<td>Not Responsive</td>";
    

    echo "<td>Rejecting Cuddles</td>";
	
    echo "<td>Reacting Neagatively</td>";
...
{
include('update_b_degree_res.php');
echo "<table width='1312' border='1' cellspacing='0' style='text-align:center'>";
  echo "<tr>";
...
{
include('aggregation_res.php');
echo "<center>";
echo "<table width='400' border='1' cellspacing='0' style='text-align:center;margin-top:100px'>";
echo "<caption style='font-size:25px;font-weight:bold'>Responding</caption>";
  echo "<tr>";
