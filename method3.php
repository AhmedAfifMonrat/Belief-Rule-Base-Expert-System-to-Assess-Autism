...
echo "<table width='1312' border='1' cellspacing='0' style='text-align:center'>";
  echo "<tr>";
    ...
    echo "<td>Bitterness</td>";
    

    echo "<td>Avoiding Eye Contact</td>";
	
    echo "<td>Less Interested Towards Parties & Friends</td>";
...
{
include('aggregation_int.php');
echo "<center>";
echo "<table width='400' border='1' cellspacing='0' style='text-align:center;margin-top:100px'>";
echo "<caption style='font-size:25px;font-weight:bold'>Interaction</caption>";
  echo "<tr>";
