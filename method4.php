...
echo "<table width='1312' border='1' cellspacing='0' style='text-align:center'>";
  ...
  echo "<td>Serial</td>";
    ...
    echo "<td>Chromosomal Abnormality</td>";
    

    echo "<td>Viral Agent</td>";
	
    echo "<td>Immune Intolerance</td>";
...
{
include('update_b_degree_gen.php');
echo "<table width='1312' border='1' cellspacing='0' style='text-align:center'>";
  echo "<tr>";
...
{
include('aggregation_gen.php');
echo "<center>";
echo "<table width='400' border='1' cellspacing='0' style='text-align:center;margin-top:100px'>";
echo "<caption style='font-size:25px;font-weight:bold'>Genetic</caption>";
  echo "<tr>";
